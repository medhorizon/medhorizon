export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w MedHorizon.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w medhorizon.json",
  ...
  "dialog.server.description": "Przełącz serwer MedHorizon, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja MedHorizon ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu MedHorizon",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (medhorizon.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, MedHorizon nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla MedHorizon",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd MedHorizon na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw MedHorizon.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania MedHorizon",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji MedHorizon.",
