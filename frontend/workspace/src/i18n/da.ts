export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i MedHorizon.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i medhorizon.json",
  ...
  "dialog.server.description": "Skift hvilken MedHorizon-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af MedHorizon ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til MedHorizon-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (medhorizon.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, MedHorizon understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for MedHorizon",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan MedHorizon ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan MedHorizon er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når MedHorizon starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af MedHorizon.",
