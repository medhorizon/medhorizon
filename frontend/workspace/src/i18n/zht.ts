...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MedHorizon 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MedHorizon 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MedHorizon 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 medhorizon.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 MedHorizon 伺服器。",
  ...
  "toast.update.description": "MedHorizon 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MedHorizon 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (medhorizon.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: MedHorizon 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 MedHorizon 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 MedHorizon 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MedHorizon 的主題。",
  ...
  "settings.updates.row.startup.description": "在 MedHorizon 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 MedHorizon。",
