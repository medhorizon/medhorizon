...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i MedHorizon.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i medhorizon.json",
  ...
  "dialog.server.description": "Bytt hvilken MedHorizon-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av MedHorizon ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til MedHorizon-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (medhorizon.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at MedHorizon ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for MedHorizon",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan MedHorizon ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan MedHorizon er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når MedHorizon starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av MedHorizon.",
