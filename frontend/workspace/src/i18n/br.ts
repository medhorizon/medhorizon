export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no MedHorizon.",
  ...
  "dialog.plugins.empty": "Plugins configurados em medhorizon.json",
  ...
  "dialog.server.description": "Trocar para qual servidor MedHorizon este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do MedHorizon ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do MedHorizon",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (medhorizon.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: MedHorizon ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do MedHorizon",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o MedHorizon aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o MedHorizon é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o MedHorizon iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do MedHorizon.",
