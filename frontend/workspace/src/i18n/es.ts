export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en MedHorizon.",
  ...
  "dialog.plugins.empty": "Plugins configurados en medhorizon.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de MedHorizon se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de MedHorizon ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de MedHorizon",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (medhorizon.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, MedHorizon no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "MedHorizon incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para MedHorizon",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve MedHorizon en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de MedHorizon.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia MedHorizon",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de MedHorizon.",
