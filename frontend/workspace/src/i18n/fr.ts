export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans MedHorizon.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans MedHorizon.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans MedHorizon.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans medhorizon.json",
  ...
  "dialog.server.description": "Changez le serveur MedHorizon auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version de MedHorizon ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe MedHorizon",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (medhorizon.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    'Le serveur MCP "{{name}}" a échoué. Notez que MedHorizon ne supporte pas encore l\'authentification MCP.',
  ...
  "atlas.stages.toastNotRestored": "aucune modification de fichier à annuler",
  "atlas.stages.toastError": "impossible de redémarrer",
  ...
  "sidebar.gettingStarted.line1":
    "MedHorizon inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour MedHorizon",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence de MedHorizon sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de MedHorizon.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de MedHorizon",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de MedHorizon.",
