  ...
  const unsub = globalSDK.event.listen((e) => {
    ...
    const cleanupSessionCaches = (sessionID: string) => {
      ...
      const hasAny =
        ...
        store.session_stages[sessionID] !== undefined ||
      ...
      setStore(
        produce((draft) => {
          ...
          delete draft.session_stages[sessionID]
    ...
    switch (event.type) {
      ...
      case "session.diff":
        ...
        break
      case "session.stage.updated":
        setStore("session_stages", event.properties.sessionID, reconcile(event.properties.stages, { key: "partID" }))
        break
      case "todo.updated":
