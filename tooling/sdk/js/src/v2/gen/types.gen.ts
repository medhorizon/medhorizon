...
export type EventSessionStageUpdated = {
  type: "session.stage.updated"
  properties: {
    sessionID: string
...
export type StageJumpResult = {
  session: Session
  stage: StageNode
  /**
   * Worktree state captured before the restore; use it to recover
   */
...
export type SessionStagesData = {
  ...
  url: "/session/{sessionID}/stages"
}

export type SessionStagesErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionStagesError = SessionStagesErrors[keyof SessionStagesErrors]

export type SessionStagesResponses = {
  /**
   * Stage list
   */
  200: Array<StageNode>
...
export type SessionStagesResponse = SessionStagesResponses[keyof SessionStagesResponses]

export type SessionStageJumpData = {
  body?: {
    /**
     * Stage part to jump to
     */
    partID: string
    /**
     * Restore the worktree to the stage's snapshot. The worktree is shared per directory.
     */
  ...
  url: "/session/{sessionID}/stages/jump"
}

export type SessionStageJumpErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type SessionStageJumpError = SessionStageJumpErrors[keyof SessionStageJumpErrors]

export type SessionStageJumpResponses = {
  /**
   * Forked session and the stage it restarts from
   */
  200: StageJumpResult
}

export type SessionStageJumpResponse = SessionStageJumpResponses[keyof SessionStageJumpResponses]
